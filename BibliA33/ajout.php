        ...
        if (isset($_SESSION['LOGID'])) {
            ...
            <div id="main_content">
                ...
                <form action="ajoutPlus/ajouter.php" method="GET">
                    ...
                    <p>ISBN</p>
                    <input id="isbn" type="text" name="isbn" value="" placeholder="ISBN" title="L'ISBN doit ressembler à : XXX-X-XXXX-XXXX-X" required/><br/><br/><br/>
                    <div id="auteur">
                        Auteur :</br>
                        <select id="select_auteur" name="auteur[]" type="select" multiple size="3" onchange="ajoutFon();" required>
                            <option id="value_auteur" value="ajoutAut">Ajouter</option>
                            <?php
