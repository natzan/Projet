...
<html>
    ...
    <body onload="verif();">
        ...
        if (isset($_SESSION['LOGID'])) {
            ...
            ?>
            <div id="current_page">
                <h1>Liste Emprunts</h1><h2>Connecté(e) : <?php echo $_SESSION['LOGID'];?></h2>
            </div>
            <div id="main_content">
                <h2>Impression : </h2>
                <?php
                $sql = "SELECT * FROM client, emprunter, livre WHERE client.CLIENT_ID = emprunter.CLIENT_ID and emprunter.LIV_ISBN = livre.LIV_ISBN ORDER BY EMP_DATE DESC";
                    ...
                    <div id="divImpr">  <!--Ce div permet de délimiter la zone d'impression pour les emprunts-->
                        <table>
                            ...
                            while ($ligne = $table->fetch()) {
                                ...
                                if ($ligne["EMP_DATE_R_REEL"] == NULL) {
                                    $EMP_DATE_R_REEL = 'Non rendu';
                                }
                                ?>
                                <tr>
