...
//            $nomImage = md5(uniqid()) .'.'. $extension;
    ...
    //var_dump($_SESSION);
              $sql = "SELECT * FROM client WHERE CLIENT_ID='".$_SESSION['CLIENT_ID']."';";
              //echo $sql;
...
?>
    <div id="current_page">
        <h1>Modification Comptes Client</h1><h2>Connecté(e) : <?php echo $ligne['CLIENT_NOM'];?></h2>
    </div>
     <div id="main_content">
			<p>Modifier un client<p>
                        ...
                        <form action="modifAutre/modificationProfilClient.php" method="GET">
                               <input type="hidden" name="client" value="<?php echo $_SESSION['CLIENT_ID']; ?>"><br/>
        ...
        <h3>(vous allez être rediriger vers la page de connexion)</h3>
