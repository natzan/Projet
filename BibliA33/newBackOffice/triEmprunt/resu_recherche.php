...
if(isset($_GET["clientNom"]) && isset($_GET["clientPrenom"])) {
  $clientPrenom=($_GET["clientPrenom"]);
  $clientNom=($_GET["clientNom"]);

  $sql = "SELECT * FROM client, emprunter, livre WHERE client.CLIENT_ID = emprunter.CLIENT_ID and emprunter.LIV_ISBN = livre.LIV_ISBN and CLIENT_NOM = '".$clientNom."' and CLIENT_PRENOM = '".$clientPrenom."'" ;
