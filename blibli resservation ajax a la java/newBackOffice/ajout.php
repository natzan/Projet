...
<html>
    ...
    <body>
        ...
        if (isset($_SESSION['LOGID'])) {
            ...
            <?php //éditer SESSION par le get JAVASCRIPT pour utiliser apres
            // changer les value des champs text pour que cela saffiche
            // utiliser balise javascript pour actualiser la page d que lon touche a champ text
            ...
            <div id="main_content">
                ...
                <form action="ajoutPlus/ajouter.php" method="GET">
                    ...
                    <p>ISBN</p>
                    <input id="isbn" type="text" name="isbn" value="catch" placeholder="ISBN" title="L'ISBN doit contenir 20 caractères maximum" onchange="session()" required/><br/><br/><br/>
                    <div id="auteur">
                        Auteur :</br>
                        <select id="select_auteur" name="auteur[]" type="select" multiple size="3" onchange="ajoutFon();" required>
                            <option id="ajout_auteur" value="ajoutAut">Ajouter</option> PASSER VALEUR ICI
                            <?php
