...
<html>
    ...
    <body>
        ...
        ?>
            <div id="current_page">
                    <h1>Index</h1>
					<h2>Connect&eacute;(e) : <?php echo $_SESSION['CLIENT_NOM']; ?></h2>
                    ...
                    while ($donnees1 = $reponse1->fetch()) {
                        $don = '                                                 
                                                        <tr> 
                                                            ...
                                                            <th><input type="radio" name="avis" value="' . $donnees['EMP_ID'] . '"></th>                                                        </tr>';
                        echo $don;
                    }
                }
                ?>
            ...
            if ($ligne['nb'] > 0) {
                //echo $ligne['nb'];
                ?>
                <center><input type="submit" name="1" value="Donner votre avis"></center>
                <center><input type="submit" name="2" value="Modifier"/></center>
